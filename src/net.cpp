...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Subcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"subcointools.com", "46.105.101.90"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"subcointools.com", "testnet-seed.subcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Subcoin is probably already running."), addrBind.ToString().c_str());
        else
